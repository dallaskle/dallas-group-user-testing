  ...
  useEffect(() => {
    const verifyEmail = async () => {
      ...
      if (accessToken && type === 'signup') {
        console.log('accessToken and type is signup')
        try {
          setIsProcessing(true)
          console.log('Processing verification with token')
          ...
          try {
            ...
            console.log('Session set result:', { hasData: !!data, hasError: !!error })
            ...
            console.log('Current session check:', { hasSession: !!currentSession })
            ...
            console.log('User check result:', { hasUser: !!existingUser, hasError: !!userCheckError })
          ...
          toast.error('Failed to complete verification. Please try logging in.')
          navigate('/login')
        }
      }
    }
