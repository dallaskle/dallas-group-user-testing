...
-- Recreate trigger function with fixed changed_by value
...
COMMENT ON FUNCTION log_ticket_changes IS 'Logs changes to ticket fields for audit purposes using auth.uid() for changed_by'; 